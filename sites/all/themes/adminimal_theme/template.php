...
function adminimal_preprocess_html(&$vars) {
  ...
  // Add default styles.
  drupal_add_css($adminimal_path . '/css/reset.css', array(
    'group' => CSS_THEME,
    'media' => 'all',
    'weight' => -999
  ));
  drupal_add_css($adminimal_path . '/css/style.css', array(
    'group' => CSS_THEME,
    'media' => 'all',
    'weight' => 1
  ));
  ...
  drupal_add_css($adminimal_path . '/css/ie.css', array(
    'group' => CSS_THEME,
  ...
  drupal_add_css($adminimal_path . '/css/ie7.css', array(
    'group' => CSS_THEME,
  ...
  drupal_add_css($adminimal_path . '/css/ie6.css', array(
    'group' => CSS_THEME,
  ...
  if (theme_get_setting('display_icons_config')) {
    drupal_add_css($adminimal_path . '/css/icons-config.css', array(
      'group' => CSS_THEME,
      'weight' => 10,
      'preprocess' => FALSE
    ));
  ...
  drupal_add_css($adminimal_path . '/css/mobile.css', array(
    'group' => CSS_THEME,
    'media' => $media_query_mobile,
    'weight' => 1000
  ));
  drupal_add_css($adminimal_path . '/css/tablet.css', array(
    'group' => CSS_THEME,
